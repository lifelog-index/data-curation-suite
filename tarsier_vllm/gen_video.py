#!/usr/bin/env python3
"""
Ví dụ: inference Tarsier2 (omni-research/Tarsier2-...) với input video trên vLLM.

Yêu cầu:
- vllm phiên bản có hỗ trợ Tarsier2 (hoặc cài từ repo main nếu cần).
- pip install opencv-python pillow vllm
"""
